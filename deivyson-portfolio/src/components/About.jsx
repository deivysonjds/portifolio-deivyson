        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className={`md:w-2/3 md:pl-12 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <p className="mb-6 text-lg">
              Como desenvolvedor Full stack, tenho experiência com Node.js, java com spring boot, PostgreSQL, Fastify, prismaORM, React, angular.
            </p>
            ...
            <a href="/cv.pdf" target="_blank" rel="noopener noreferrer" download={true}>
